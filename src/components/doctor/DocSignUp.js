...
class DocSignUp extends React.Component {
    ...
    handleSubmit = (e) => {
        ...
        .then(newDocObj => {
            if (newDocObj.error){
                this.setState({
                    error: newDocObj.error,
                    showModal: true
                })
            } else {
               this.props.signUpDoctor(newDocObj)
            ...
            <div className="sign-up-div">
                ...
                <Form onSubmit={this.handleSubmit} >
                    ...
                    <Form.Row style={{width: '70%', marginLeft: '15%', textAlign:'center'}}>
                        ...
                        <Form.Control name="gender" value={this.state.gender} onChange={this.handleInputChange} />
                        </Form.Group>
                    </Form.Row>
...
export default connect(null, mapDispatchToProps)(DocSignUp)